...
public class ChartApplet extends Applet {
	...
	public void init() {
		...
		String dataXML = "G:/Develop/eclipse/workspace/BirtChartJsExt/WebContent/data.xml";// getParameter
		// (
		// "dataXML"
		// )
			...
			try {
				if (dataXML == null) {
					throw new IllegalArgumentException(
							"XML for Chart model is required.");
				}
				ChartModel chart = new ChartXMLParser(this.dataXML)
						.createChart();
				...
				IDeviceRenderer idr = ChartEngine.instance(config).getRenderer(
						"dv.SWING");//$NON-NLS-1$
				...
				gr.bindData(ChartConvertor.convertToEvaluator(chart), cm, rtc);
